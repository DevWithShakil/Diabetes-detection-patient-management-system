    ...
    <div class="row justify-content-center">
        <div class="col-lg-9">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 class="fw-bold mb-1 text-dark">Edit Patient Record</h4>
                    <p class="small text-muted mb-0">Update vitals for Patient ID: #{{ $patient->id }}.</p>
                </div>
            ...
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                <div class="card-header bg-white p-4 border-bottom border-light">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h6 class="mb-0 fw-bold text-dark">{{ $patient->name }}'s Vitals</h6>
                            <small class="text-muted">Last Updated: {{ $patient->updated_at->format('M d, Y') }}</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    @if ($errors->any())
                        <div class="alert alert-danger border-0 bg-danger bg-opacity-10 rounded-3 mb-4">
                            <strong class="text-danger"><i class="fa-solid fa-exclamation-circle me-2"></i> Please correct the following errors:</strong>
                            <ul class="mb-0 mt-2 small text-danger ps-4">
                    ...
                    <form action="{{ route('patients.update', $patient->id) }}" method="POST">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control bg-light border-start-0 ps-0"
                                           value="{{ old('name', $patient->name) }}" placeholder="Enter patient's full name" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="age" class="form-control bg-light border-start-0 ps-0"
                                           value="{{ old('age', $patient->age) }}" placeholder="e.g. 45" required>
                                </div>
                            </div>
                        </div>

                        <h6 class="text-uppercase text-success fw-bold small mb-3 ls-1"><i class="fa-solid fa-heart-pulse me-2"></i> Clinical Vitals (For AI Re-Analysis)</h6>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group shadow-sm">
                                        ...
                                        <input type="number" name="glucose" class="form-control border-start-0 ps-0"
                                               value="{{ old('glucose', $patient->glucose) }}" placeholder="e.g. 120" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group shadow-sm">
                                        ...
                                        <input type="number" name="blood_pressure" class="form-control border-start-0 ps-0"
                                               value="{{ old('blood_pressure', $patient->blood_pressure) }}" placeholder="e.g. 80" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group shadow-sm">
                                        ...
                                        <input type="number" step="0.1" name="bmi" class="form-control border-start-0 ps-0"
                                               value="{{ old('bmi', $patient->bmi) }}" placeholder="e.g. 25.5" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group shadow-sm">
                                        ...
                                        <input type="number" name="insulin" class="form-control border-start-0 ps-0"
                                               value="{{ old('insulin', $patient->insulin) }}" placeholder="e.g. 85" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group shadow-sm">
                                        ...
                                        <input type="number" name="skin_thickness" class="form-control border-start-0 ps-0"
                                               value="{{ old('skin_thickness', $patient->skin_thickness) }}" placeholder="e.g. 20" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group shadow-sm">
                                        ...
                                        <input type="number" step="0.001" name="diabetes_pedigree" class="form-control border-start-0 ps-0"
                                               value="{{ old('diabetes_pedigree', $patient->diabetes_pedigree) }}" placeholder="e.g. 0.587" required>
                                    </div>
                                </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-5">
                            <button type="button" onclick="window.history.back()" class="btn btn-light text-muted fw-bold">Cancel</button>

                            <button type="submit" class="btn btn-primary btn-lg rounded-pill px-5 fw-bold shadow-sm">
                                <i class="fa-solid fa-arrows-rotate me-2"></i> Update & Re-Analyze
                            </button>
                        </div>
